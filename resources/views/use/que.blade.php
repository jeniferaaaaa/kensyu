                ...
                <div class="panel-body">
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q1" value="1"> 事業推進統括部
                            <input type="radio" name="q1" value="2"> サービス管理統括部
                            <input type="radio" name="q1" value="3"> DX第一統括部
                            <input type="radio" name="q1" value="4"> DX第二統括部
                        </div>
                        @if ($errors->has('q1'))
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q2" value="1"> 20代
                            <input type="radio" name="q2" value="2"> 30代
                            <input type="radio" name="q2" value="3"> 40代以上
                            <input type="radio" name="q2" value="4"> 人間じゃない
                        </div>
                        @if ($errors->has('q2'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q3" value="1"> 等級1
                            <input type="radio" name="q3" value="2"> 等級2
                            <input type="radio" name="q3" value="3"> 等級3
                            <input type="radio" name="q3" value="4"> 等級4
                            <input type="radio" name="q3" value="5"> 等級5
                            <input type="radio" name="q3" value="6"> 年棒
                        </div>
                        @if ($errors->has('q3'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q4" value="1"> 一般
                            <input type="radio" name="q4" value="2"> リーダ
                            <input type="radio" name="q4" value="3"> マネージャ
                            <input type="radio" name="q4" value="4"> 管理職以上
                        </div>
                        @if ($errors->has('q4'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q5" value="2"> いいえ
                        </div>
                        @if ($errors->has('q5'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q6" value="2"> いいえ
                        </div>
                        @if ($errors->has('q6'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q7" value="2"> いいえ
                        </div>
                        @if ($errors->has('q7'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q8" value="2"> いいえ
                        </div>
                        @if ($errors->has('q8'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q9" value="2"> いいえ
                        </div>
                        @if ($errors->has('q9'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q10" value="2"> いいえ
                        </div>
                        @if ($errors->has('q10'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q11" value="2"> いいえ
                        </div>
                        @if ($errors->has('q11'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q12" value="2"> いいえ
                        </div>
                        @if ($errors->has('q12'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q13" value="2"> いいえ
                        </div>
                        @if ($errors->has('q13'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q14" value="2"> いいえ
                        </div>
                        @if ($errors->has('q14'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q15" value="2"> いいえ
                        </div>
                        @if ($errors->has('q15'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q16" value="2"> いいえ
                        </div>
                        @if ($errors->has('q16'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q17" value="2"> いいえ
                        </div>
                        @if ($errors->has('q17'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q18" value="2"> いいえ
                        </div>
                        @if ($errors->has('q18'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q19" value="1"> はい
                            <input type="radio" name="q19" value="2"> いいえ
                        </div>
                        @if ($errors->has('q19'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q20" value="1"> はい
                            <input type="radio" name="q20" value="2"> いいえ
                        </div>
                        @if ($errors->has('q20'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q21" value="1"> はい
                            <input type="radio" name="q21" value="2"> いいえ
                        </div>
                        @if ($errors->has('q21'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q22" value="1"> はい
                            <input type="radio" name="q22" value="2"> いいえ
                        </div>
                        @if ($errors->has('q22'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q23" value="1"> はい
                            <input type="radio" name="q23" value="2"> いいえ
                        </div>
                        @if ($errors->has('q23'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q24" value="1"> はい
                            <input type="radio" name="q24" value="2"> いいえ
                        </div>
                        @if ($errors->has('q24'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q25" value="1"> はい
                            <input type="radio" name="q25" value="2"> いいえ
                        </div>
                        @if ($errors->has('q25'))
                        <div class="form-group has-error">
                            <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" name="q26" value="1"> はい
                            <input type="radio" name="q26" value="2"> いいえ
                        </div>
                        @if ($errors->has('q26'))
                        <div class="form-group has-error">
                            <span class="help-block">
